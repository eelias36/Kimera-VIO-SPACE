...
/**
 * @file   Mono2VisionImuFrontend.cpp
...
Mono2VisionImuFrontend::Mono2VisionImuFrontend(
...
Mono2VisionImuFrontend::~Mono2VisionImuFrontend() {
  LOG(INFO) << "Mono2VisionImuFrontend destructor called.";
}

StereoFrontendOutput::UniquePtr Mono2VisionImuFrontend::bootstrapSpinStereo(
...
StereoFrontendOutput::UniquePtr Mono2VisionImuFrontend::nominalSpinStereo(
    StereoFrontendInputPayload::UniquePtr&& input) {
  // For timing
  ...
  if (VLOG_IS_ON(5))
    Mono2VisionImuFrontend::printStatusStereoMeasurements(
...
void Mono2VisionImuFrontend::processFirstStereoFrame(
...
// misleading
StatusStereoMeasurementsPtr Mono2VisionImuFrontend::processStereoFrame(
...
void Mono2VisionImuFrontend::getSmartStereoMeasurements(
...
/* -------------------------------------------------------------------------- */
void Mono2VisionImuFrontend::sendFeatureTracksToLogger() const {
  CHECK(tracker_);
...
/* -------------------------------------------------------------------------- */
void Mono2VisionImuFrontend::sendStereoMatchesToLogger() const {
  CHECK(tracker_);
...
/* -------------------------------------------------------------------------- */
void Mono2VisionImuFrontend::sendMonoTrackingToLogger() const {
...
// RANSAC
gtsam::Pose3 Mono2VisionImuFrontend::getRelativePoseBodyMono() const {
...
// RANSAC
gtsam::Pose3 Mono2VisionImuFrontend::getRelativePoseBodyStereo() const {
  gtsam::Pose3 body_Pose_cam_ =
      stereo_camera_->getBodyPoseLeftCamRect();  // of the left camera!!
...
void Mono2VisionImuFrontend::printStatusStereoMeasurements(
