...
bool EurocDataProvider::parseDataset() {
  ...
  static const std::string ground_truth_name = "state_groundtruth_estimate0"; // ERIC ELIAS
  is_gt_available_ = parseGtData(dataset_path_, ground_truth_name); // ERIC ELIAS
