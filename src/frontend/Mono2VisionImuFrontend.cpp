...
DEFINE_bool(log_mono2_matching_images,
            false,
...
MonoFrontendOutput::UniquePtr Mono2VisionImuFrontend::bootstrapSpinMono(
...
MonoFrontendOutput::UniquePtr Mono2VisionImuFrontend::nominalSpinMono(
    MonoFrontendInputPayload::UniquePtr&& input) {
  // For timing
  ...
  if (VLOG_IS_ON(5))
    Mono2VisionImuFrontend::printStatusMonoMeasurements(
...
void Mono2VisionImuFrontend::processFirstFrame(const Frame& first_frame) {
...
StatusMonoMeasurementsPtr Mono2VisionImuFrontend::processFrame(
  ...
  if (new_keyframe) {
    ...
    if (logger_ &&
      ...
      if (FLAGS_log_mono2_matching_images) sendMonoTrackingToLogger();
    }
...
void Mono2VisionImuFrontend::getSmartMonoMeasurements(
...
void Mono2VisionImuFrontend::printStatusMonoMeasurements(
