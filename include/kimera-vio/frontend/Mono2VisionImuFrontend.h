...
#include "kimera-vio/frontend/Mono2VisionImuFrontend-definitions.h"
...
class Mono2VisionImuFrontend : public VisionImuFrontend {
 public:
  KIMERA_POINTER_TYPEDEFS(Mono2VisionImuFrontend);
  KIMERA_DELETE_COPY_CONSTRUCTORS(Mono2VisionImuFrontend);
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

 public:
  Mono2VisionImuFrontend(
  ...
  virtual ~Mono2VisionImuFrontend();
